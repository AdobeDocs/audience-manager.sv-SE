...
Kunder som uppgraderar sina [!DNL Audience Manager Plug-in for IAB TCF] implementering från [!DNL IAB TCF] v1.1 till [!DNL IAB TCF] v2.2, eller aktivera [!DNL IAB TCF] v2.2 ska för första gången följa samma riktlinjer för förutsättningar och implementering som beskrivs nedan.
...
2. Du måste använda Audience Manager [!DNL Data Integration Library] (DIL) version 9.0 eller senare, kan hämtas från [här](https://github.com/Adobe-Marketing-Cloud/dil/releases). Läs om [DIL i dokumentationen till Audience Manager](../../dil/dil-overview.md). Vi rekommenderar [Adobe Audience Manager-taggtillägg](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/audience-manager/overview.html) för det enklaste DIL-genomförandet av Audience Manager.
