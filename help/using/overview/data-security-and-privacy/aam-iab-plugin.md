...
Plugin-programmet Audience Manager för IAB TCF använder [Opt-in-funktionen](https://experienceleague.adobe.com/docs/id-service/using/implementation/opt-in-service/iab.html), som i sin tur är en del av [Adobe Experience Platform Identity Service-biblioteket (ECID)](https://experienceleague.adobe.com/docs/id-service/using/home.html).
...
2. Du måste använda Audience Manager [!DNL Data Integration Library] (DIL) version 9.0 eller senare, kan hämtas från [här](https://github.com/Adobe-Marketing-Cloud/dil/releases). Läs mer om [DIL i dokumentationen för Audience Manager](../../dil/dil-overview.md). Vi rekommenderar att du använder [Adobe Audience Manager-taggtillägget](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/audience-manager/overview.html) för den enklaste DIL-implementeringen av Audience Manager.
3. Om du använder [!DNL Server-Side Forwarding] (SSF) för att importera data till Audience Manager måste du uppgradera till den senaste versionen av AppMeasurementet. Hämta AppMeasurement med [Analytics Code Manager](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/code-manager-admin.html).
...
## Recommendations och implementera {#recommendations}
...
Det enklaste sättet att göra detta är att använda [Adobe Experience Platform-taggar](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=en) för att lägga till [!DNL ECID Opt-in] i egenskaperna. Läs dokumentationen för tillägget [ECID Opt-in](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html) om du vill veta mer om hur du konfigurerar tillägget Taggar.
...
6. Audience Manager svarar genom att ställa in en [demdex-cookie](https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html) i webbläsaren och initierar och respekterar synkroniseringar för tredje parts-ID.
...
4. Om IAB TC-strängen saknas eller saknar de behörigheter som krävs, släpper Audience Manager de data som skickas i variablerna `gdpr` och `gdpr_consent` i pixelanrop.
...
Om du vill testa att du har implementerat insticksprogrammet Audience Manager för IAB TCF korrekt läser du [Använd fall 4 i validera instickstjänsten](https://experienceleague.adobe.com/docs/id-service/using/implementation/opt-in-service/testing-optin-and-iab-plugin.html#section-64331998954d4892960dcecd744a6d88).
