...
|---|---|---|
| `namespace` | Sträng | Obligatoriskt. Representerar Experience Cloud-organisations-ID:t. Detta krävs för kärnfunktionaliteten i Experience Cloud. Samma parameter som används för att instansiera funktionaliteten för besökar-ID. |
