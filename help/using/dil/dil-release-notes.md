...
På den här sidan finns information om de senaste DIL-versionerna. DIL finns som nedladdningsversion, med versionsinformation, på Adobe [Github-sidan](https://github.com/Adobe-Marketing-Cloud/dil/releases).
