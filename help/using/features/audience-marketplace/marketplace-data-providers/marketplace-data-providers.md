...
[!UICONTROL My Shared Data] är en [!UICONTROL Audience Marketplace] för dataleverantörer (säljare). Som leverantör kan ni paketera egenskaper i dataflöden och sälja dem till en fast avgift eller [!DNL CPM] till köpare inifrån [!DNL Audience Manager]. När det är aktiverat kan köpare prenumerera på en feed med några musklick. Dessutom spårar enkla rapporteringsverktyg intäkter och hanterar abonnenter. Äntligen med [!UICONTROL Audience Marketplace], [!DNL Adobe] tar hand om fakturering, fakturering och avgiftsbetalningar åt dig. Med dessa funktioner kan ni koncentrera er på att bygga upp de effektiva och lönsamma dataflöden som köparna vill ha.
...
* **Total avgift förra månaden:** Det abonnerade datainköpare som är skyldiga dig. Rapportperioden löper ut den 10 i varje månad. Försenade konton flaggas med ikonen för triangel-/utropstecken. Du kan [avaktivera en abonnents datafeed](../../../features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#deactivate-data-feed) om de missbrukar dina data eller om deras konto är försenat.
