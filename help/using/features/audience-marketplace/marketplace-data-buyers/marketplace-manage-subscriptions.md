...
The [!UICONTROL Marketplace] där datainköpare går till forskning och abonnerar på offentliga och privata dataflöden. Följ de här stegen för att prenumerera på en offentlig datafeed.
...
1. Klicka på namnet på den datafeed som du vill använda. Då öppnas [planinformationssida](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#marketplace-buyer-details) för vald feed.

   ![plan-details](assets/plan-details.png)

1. Välj ett användningsfall i prenumerationstabellen och:
   * Flytta **[!UICONTROL Subscription]** skjutreglage till **[!UICONTROL On]**.
   * Klicka på **[!UICONTROL Review & Subscribe]**. Då öppnas [!UICONTROL Terms and Conditions] -fönstret.

   ![prenumerera](assets/subscribe3.png)

1. I [!UICONTROL Terms and Conditions] window:

   * **Viktigt:** Lämna **[!UICONTROL ID sync]** kryssrutan är markerad. Den här inställningen hjälper till att förbättra matchningsfrekvensen hos din DataProvider.
...
* Verifiera prenumerationen genom att kontrollera din [!UICONTROL Traits] mapp. Se [Lagring för abonnerade dataflöden](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#find-subscribed-data-fee).
...
När du utforskar nya datauppsättningar från tredje part och andra leverantörer via [!UICONTROL Audience Marketplace]är det första steget vi rekommenderar att aktivera dataflöden för [!UICONTROL Segments & Overlap]. På så sätt kan användarna utforska data genom att bygga segment för att utvärdera målgruppens storlek och köra överlappningsrapporter för att få inledande målgruppsinsikter. De flesta dataleverantörer erbjuder denna användning kostnadsfritt, så du kan utföra analysen utan extra kostnad.
...
1. Det finns ingen garanti för att datauppsättningarna kommer att överlappa varandra. För att en överlappning ska vara giltig måste en användare från kundens datauppsättning kopplas till dataleverantörens datauppsättning under rapportens tidsram. Om kundens mediedata inte delades ut till användarna i dataleverantörens datauppsättning kommer det aldrig att finnas någon överlappning.
...
1. Klicka på dataflödets namn i dialogrutan [!UICONTROL Marketplace].
1. Klicka på **[!UICONTROL Request Access]**. Då öppnas dialogrutan för förfrågan.
1. Skriv en anteckning som uttrycker ditt intresse för dataflödet i dialogrutan med begäran och klicka på **[!UICONTROL Send]**. Säljaren granskar ditt meddelande och godkänner eller avvisar din förfrågan. I väntan på godkännande visas&quot;Begärt&quot; i [!UICONTROL Marketplace] lista för denna datafeed.

   * **[!UICONTROL Request approved]**: Statusen i [!UICONTROL Marketplace] så får du ett automatiskt meddelande om ändringarna i &quot;Åtkomst beviljad&quot;. Nu kan du prenumerera på feeden. Se [Prenumerera på en offentlig datafeed](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-public-data-feed) för instruktioner.
   * **[!UICONTROL Request denied]**: Den begärda texten tas bort från [!UICONTROL Marketplace] lista för feeden. Du kan försöka prenumerera igen eller välja en annan feed.

## Rabatter på dataflöden för köpare {#buyer-discount}

I [!UICONTROL Audience Marketplace]kan leverantörerna ge köparna rabatt på det publicerade priset på en [!DNL CPM] eller dataflöde med schablonbelopp. Rabattbelopp är dock inte synliga för köpare i [!DNL Marketplace] feed-lista. Men du kan också be om en rabatt när du prenumererar på ett privat dataflöde eller när du begär mer information om ett visst flöde.
...
<table id="table_3C6E58F593BA48EC89ACBD9A26E4E74F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Om du redan prenumererar på en privat datafeed och vill begära en rabatt: </p> 
    <ol id="ol_A58D419EBB9349E9B1225202535130F6"> 
     ...
     <li id="li_B1B5AA6F6CC64512A02D5E8861A5F266">Om leverantören ger dig rabatt återprenumererar du på feeden på 1<sup>st</sup> dag i nästa månad. </li> 
    </ol> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A <a href="../../../features/audience-marketplace/marketplace-private-feeds.md"> potentiell prenumerant</a> är en datamottagare som har begärt åtkomst till en privat datafeed, som har fått säljarens godkännande, men som inte har prenumererat på denna feed. Så här begär du en rabatt som potentiell prenumerant: </p> 
    <ol id="ol_9CECDA92E7894B20AC8A777D78962188"> 
     ...
     <li id="li_763C050AC9464BE380D00F6085B6E540">Klicka <b><span class="uicontrol"> Mer information om begäran</span></b>. Be om rabatt i din informationsförfrågan till säljaren. </li> 
    </ol> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Titta på [!UICONTROL Price] och [!UICONTROL Your Price] kolumner i [!UICONTROL Plan Details] tabell. Om fodret diskonteras:

   * Det ursprungliga priset markeras med en röd linje.
   * Avgiften i [!UICONTROL Your Price] kolumnen blir lägre än avgiften i [!UICONTROL Price] kolumn.

I exemplet får köparen 10 % rabatt på [!UICONTROL Segments and Overlap] i **[!UICONTROL Software Audience Feed]**.

![](assets/buyer-discount.png)

## Söka efter data för prenumerationsflöden {#find-subscribed-data-fee}

Data (egenskaper) för dina dataflöden visas i sina egna mappar för lagring av egenskaper. Gå till **[!UICONTROL Audience Data > Traits]** och utöka **[!UICONTROL 3rd-Party Data]** mapp för att visa och arbeta med egenskaperna i dina prenumererade feeds. Leta efter undermappen som har namngivits efter din DataProvider. Dessa innehåller mappar som namnges efter den enskilda datafeeden och listegenskaper som matningen ger.
...
1. Klicka på dataflödets namn i dialogrutan [!UICONTROL Marketplace].
1. I [!UICONTROL Use Case] -avsnittet hittar den plan du vill använda och flyttar **[!UICONTROL Subscription]** skjutreglage till **[!UICONTROL Off]**.
...
>[!TIP]
>
>Kontakta din dataleverantör direkt om du tror att en datafeed har inaktiverats av misstag. Dina [!DNL Adobe] konsulten kan hjälpa dig med kontaktinformation eller ytterligare support.

## Inaktiveringsmejl {#deactivation-email}

När en dataleverantör inaktiverar en av dina dataflöden, [!DNL Audience Manager] skickar ett e-postmeddelande till användare i ditt företag som har [!UICONTROL Administrator] behörigheter. Ibland kan e-postfilter klassificera det här meddelandet som skräppost. Därför kanske du saknar det här viktiga meddelandet. Det här e-postmeddelandet innehåller följande element som hjälper dig att identifiera inaktiveringsmeddelandet:

* **Från:** Inaktiveringsmejlet kommer från `aam-noreply@adobe.com`. Proffstips: Svara inte på det här e-postmeddelandet.

* **Ärenderad:** Prenumerera på *Namn på datafeed här* har avbrutits.
...
* Massborttagning med [REST API:er](../../../api/rest-api-main/rest-api-main.md) eller [Masshanteringsverktyg](../../../reference/bulk-management-tools/bulk-management-intro.md).
...
[Avbeställ den inaktiverade datafeeden](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#unsubscribe) när du har tagit bort alla återkallade egenskaper från ditt konto. Om detta är en tillfällig inaktivering kan du återprenumerera när dataprovidern har slutfört de ändringar som krävs och återaktiverar flödet. Som med de flesta saker, god kommunikation med dina partner (dataleverantören och [!DNL Adobe]) kan hjälpa dig att gå igenom den här processen.

## Sidan med avtalsinformation i Audience Marketplace {#marketplace-buyer-details}

När du klickar på namnet på en dataplan i dialogrutan [!UICONTROL Marketplace], [!DNL Audience Manager] innehåller information som kan hjälpa dig att göra välgrundade val när det gäller att prenumerera på ett dataflöde.
...
1. Knappar för planinformation.
   * Klicka **[!UICONTROL Explore All Traits]** om du vill se information om alla egenskaper i den valda datafeeden.
   * Klicka **[!UICONTROL Request More Details]** om du vill ställa frågor till dataleverantören om den valda datafeeden eller begära en rabatt. Den här funktionen skickar dina kommentarer och frågor direkt till DataProvider.
...
1. Data Feed Report Metrics. I Venndiagrammet (och relaterade mätvärden) visas hur ni ser överlappande data under de senaste 30 dagarna. Se [Marketplace: Om](marketplace-data-buyers.md#about-marketplace) för mer information.
   * **[!UICONTROL 30 Day Overlapped Uniques]**: Antalet unika användare på ditt konto som överlappar användarna på leverantörens konto. En definition av unika användare finns AAM UUID i [Index för ID:n i Audience Manager](/help/using/reference/ids-in-aam.md).
...
1. **[!UICONTROL Plan Details]** Tabell. I den här tabellen visas de användningsfall som du kan prenumerera på datafeeden för samt dess prismodell. Se [Förstå användningsfall för datafeed](#use-cases).

1. Planera åtgärdsknappar.
   * Klicka **[!UICONTROL Cancel]** om du vill lämna sidan utan att göra några ändringar.
   * Klicka **[!UICONTROL Review & Subscribe]** prenumerera på en datafeed. Den här knappen är nedtonad tills du byter ett [!UICONTROL Subscription] växla till [!UICONTROL On]. Se även [Prenumerera på en offentlig datafeed](#subscript-public-data-feed) och [Prenumerera på en privat datafeed](#subscript-private-data-feed).

## Förstå användningsfall för datafeed {#use-cases}

Som en [!UICONTROL Audience Marketplace] datainköpare, kan ni köpa data för överlappning, modellering och aktivering. Varje användningsfall är utformat för ett specifikt ändamål och begränsar vad du kan göra med informationen. Dessa fallbeskrivningar kan hjälpa er att fatta rätt beslut om vilken typ av dataplan ni ska köpa.
...
I det här exemplet kan du jämföra dina egenskaper med leverantörens egenskaper i en [Överlappningsrapport för trait-to-trait.](../../../reporting/dynamic-reports/trait-trait-overlap-report.md#trait-to-trait-overlap-report) Du kan också skapa eller lägga till leverantörsegenskaper i ett segment och göra ytterligare jämförelser med [segment-till-trait](../../../reporting/dynamic-reports/segment-trait-overlap-report.md) och [segment-till-segment](../../../reporting/dynamic-reports/segment-segment-overlap-report.md) rapporter. Överlappningsjämförelser kan hjälpa dig:

* **Nå fler:** Låg överlappning innebär att dina egenskaper innehåller användare som du inte har sett tidigare. Du kanske vill att dessa egenskaper ska försöka nå nya användare.
...
Med det här användningsexemplet kan du utvärdera leverantörens egenskaper i förhållande till dina egenskaper med [algoritmisk modellering](../../../features/algorithmic-models/understanding-models.md#understanding-models). I vårt algoritmiska modelleringssystem används till exempel en av dina egenskaper som utgångspunkt för jämförelse med en leverantörsegenskap. När modellen körs kan den visa om målgrupper i leverantörsledet delar konverteringsattribut som liknar dina egenskaper.

### Aktivering

Med det här användningsexemplet kan du skicka data till en [mål](../../../features/destinations/destinations.md). I [!DNL Audience Manager]är en destination ett system från tredje part (annonsserver, [!DNL DSP], [!DNL DMP], utbyte osv.) som du vill dela data med. Med [!UICONTROL Activation] I vissa fall kan du inte köra överlappningsrapporter eller testa data i en algoritmisk modell.
