...
I [!DNL Audience Lab], [!DNL Allocation Template] representerar de olika val du gör när du skapar en testgrupp:
...
Genom att duplicera en allokeringsmall kan du återanvända samma fördelning av testsegment och mål för ett annat bassegment i en ny testgrupp. Ett exempel på en allokeringsmall visas nedan. Bilden hämtas från [!UICONTROL Summary & Finalize] i **Skapa testgrupp** arbetsflöde.
...
Skapa en inledande testgrupp och välj sedan **[!UICONTROL Duplicate Allocation Template]** om du vill återanvända samma inställningar i flera testgrupper. Du kan till exempel använda den här funktionen om du kör ett test där du vill avgöra effekten av flera mål för flera segment.

1. I huvudvyn för Audience Lab söker du efter den testgrupp vars allokeringsmall du vill återge i en ny testgrupp. I listrutan väljer du **[!UICONTROL Duplicate Allocation Template]**.

   ![](assets/duplicate-allocation-template.png)

2. I [!UICONTROL Create Test Group] kan du ange ett bassegment och byta namn på testsegmenten om du vill.
3. Du *inte* ändra:
...
1. Skapa en ny testgrupp med [!UICONTROL Create Test Group] guide.
1. I **[!UICONTROL Allocate Test Segment]** kan du välja en del av målgruppen som inte ska testas.
...
1. Gå igenom resten av stegen i **[!UICONTROL Create Test Group]** arbetsflöde och välj **[!UICONTROL Finalize Group]** när du är nöjd med ditt val. Nu har du en testgrupp där en del av publiken inte kan testas.
