...
# Arbetsflöde A - Personalization baserad på all onlineaktivitet i kombination med offlinedata {#workflow-a}
...
>[!IMPORTANT]
>
> Det här steget gäller endast för [scenario 2](people-based-destinations-workflow-combined.md#configure-data-source-settings) som beskrivs ovan. Om dina befintliga [DPUID:n](../../reference/ids-in-aam.md) redan har hash-kodade e-postadresser går du till [Steg 3 - Skapa en profilkopplingsregel för segmentering](people-based-destinations-workflow-combined.md#create-merge-rule).

Anta att du vill matcha dina befintliga [DPUID](../../reference/ids-in-aam.md) med de hash-kodade e-postadresserna från tabellen nedan (den högra kolumnen) och lagra de hash-kodade e-postadresserna i den nya datakällan som du skapade i [Steg 1 - Konfigurera Source-inställningar för data](people-based-destinations-workflow-combined.md#configure-data-source-settings).
...
Du kan länka upp till 10 hash-kodade e-postadresser till en enda [DPUID](../../reference/ids-in-aam.md). Om du vill göra det avgränsar du de hash-kodade e-postadresserna med en `<TAB>` i synkroniseringsfilen.
...
Om du vill skapa nya målgruppssegment använder du [Segmentverktyget](../segments/segment-builder.md). Om du har befintliga målgruppssegment som du vill skicka till [!DNL People-Based Destinations] går du till [Steg 5 - Konfigurera personbaserad plattformsautentisering](people-based-destinations-workflow-combined.md#configure-authentication).
...
1. I avsnittet **[!UICONTROL Segment Mappings]** markerar du de segment som du vill skicka till det här målet. Detta är de segment som du skapade i [Steg 4 - Skapa målgruppssegment](people-based-destinations-workflow-combined.md#create-audience-segments).
1. Spara målet.
