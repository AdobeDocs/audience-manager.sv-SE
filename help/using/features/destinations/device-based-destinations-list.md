...
Den här sidan innehåller endast aktuella [!DNL Audience Manager] [enhetsbaserade mål](/help/using/features/destinations/add-device-based-destinations.md). I [!DNL Audience Manager] anropas även [!UICONTROL device-based destinations] [!UICONTROL server-to-server destinations]. Mer information om integrering finns i [Adobe Exchange](https://exchange.adobe.com/experiencecloud.html)-listan (där den är tillgänglig) eller kontakta [!DNL Adobe]-konsulten eller kundtjänst.
...
| [!DNL Amazon Advertising] | 01/02/2024 | 1:a dag | Ja | Nej | Nej | Nej |
...
| [!DNL MaxPoint Interactive] | 27/02/2017 | 1:a dag | Nej | Nej | Nej | Nej |
