...
Den här sidan innehåller stegvisa anvisningar om hur du kombinerar offline [!DNL CRM] data med beteendedata i realtid så att autentiserade användare kan skapa målgruppssegment och sedan skicka dessa målgruppssegment till [!DNL People-Based Destinations].
...
Om du vill kvalificera autentiserade användare för regelbaserade egenskaper måste du skicka behörigheten via [deklarerade ID:n](../declared-ids.md).
...
>[!IMPORTANT]
>
>Om du redan har en regel definierad med **[!UICONTROL Current Authenticated Profiles]** eller **[!UICONTROL Last Authenticated Profiles]** kan du hoppa till [Steg 4 - Skapa målgruppssegment](#create-audience-segments).
...
4. I **[!UICONTROL Profile Merge Rule Setup]** väljer du **[!UICONTROL Current Authenticated Profiles]** eller **[!UICONTROL Last Authenticated Profiles]** regel från **[!UICONTROL Cross-Device Options]** lista.
5. I **[!UICONTROL Cross-Device Profile Options]** markerar du de datakällor som du vill köra segmenteringen på. Dessa ska vara de datakällor som innehåller dina befintliga DPUID.
   ![merge-rule-setup](assets/pbd-pmr-combined.png)

## Steg 4 - Skapa målgruppssegment {#create-audience-segments}

Om du vill skapa nya segment använder du [Segment Builder](../segments/segment-builder.md). Om du har befintliga målgruppssegment som du vill skicka till [!DNL People-Based Destinations], hoppa till [Steg 5 - Konfigurera personbaserad plattformsautentisering](#configure-authentication).
...
1. I **[!UICONTROL Segment Mappings]** markerar du de segment som du vill skicka till det här målet. Det här är segmenten som du skapade på [Steg 4 - Skapa målgruppssegment](#create-audience-segments).
1. Spara målet.
