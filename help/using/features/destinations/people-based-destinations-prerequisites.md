...
[!UICONTROL People-Based Destinations] är en premiumfunktion som förbättrar din Audience Manager-upplevelse genom att du kan aktivera egna målgruppssegment i personbaserade miljöer genom att rikta in målgruppen mot anpassade erbjudanden i sociala nätverk eller via e-postmarknadsföring.
...
Videoinstruktioner finns i [Förstå och konfigurera det personbaserade LinkedIn-målet](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/data-activation/people-based-destinations/understanding-and-configuring-the-linkedin-pbd.html?lang=sv-SE).
...
![Audience Manager-gränssnittsbild som visar alternativet att dela associerade enhets-ID:n i personbaserade mål och/eller hashad e-postarbetsflöden](assets/data-source-share-ids.png)
...
Om dina kunder vill avanmäla sig från annonskampanjer finns mer information om hur du kan stoppa Audience Manager från att samla in data i [Opt-out Management](../../overview/data-security-and-privacy/data-privacy-requests.md) .
...
* Använd [Deklarerade ID:n](../declared-ids.md) om du vill deklarera hashade e-postadresser när autentiserade kund-ID skickas. När du använder den här metoden skickar Audience Manager bara den hashad e-postadressen från användare som har autentiserat online till [!UICONTROL People-Based Destinations]. E-postadresserna som aktiveras via personbaserade kanaler är bara de som anges i de deklarerade ID-händelseanropen. Andra e-postadresser som är kopplade till kund-ID:t skickas inte i realtid.
