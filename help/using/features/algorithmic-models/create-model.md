...
I [!UICONTROL Model Builder] kan du med [!UICONTROL Basic Information]-inställningarna skapa nya eller redigera befintliga modeller. Om du vill skapa en ny modell anger du ett namn och går vidare till [!UICONTROL Configuration]-inställningarna. Beskrivningsfältet är valfritt.
...
<table id="table_7A6BE5E5498D4776A30323B743954150"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Just nu fungerar Model Builder endast med vår egen <span class="keyword">-algoritm för trait Weight</span>. <span class="keyword"> Audience </span> Manager kan lägga till andra algoritmiska funktioner i efterföljande versioner. </p> </td>
  </tr>
  <tr> 
