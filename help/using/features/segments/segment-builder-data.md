...
Lägg till och ta bort [!UICONTROL traits] in [!UICONTROL Segment Builder] för att se faktisk [!UICONTROL trait] populationer tillsammans med faktiska och uppskattade segmentpopulationsdata. Den beräknade populationsstorleken hjälper er att bygga upp rätt segment för kampanjen.

## [!UICONTROL Trait] Populationsdata {#trait-population-data}

[!UICONTROL Segment Builder] visar [!UICONTROL Total Trait Population] för sista dagen när du lägger till en [!UICONTROL trait] till ett segment. Dessa data visas i det blå fältet runt det markerade [!UICONTROL trait] i [!UICONTROL Basic View] -avsnitt.
...
* För uppskattade uppgifter om segmentpopulationen (realtid och totalt) [!UICONTROL Segment Builder] uppdaterar inte diagrammen automatiskt när du lägger till eller tar bort egenskaper i ett segment. Klicka **[!UICONTROL Calculate Estimates]** för att visa (eller uppdatera) de beräknade populationssiffrorna.

* För faktiska (reella) segmentpopulationsdata (realtid och totalt), [!UICONTROL Segment Builder] uppdaterar segmentdiagrammet automatiskt när du läser in ett befintligt segment. För nya segment, eller när du lägger till nya egenskaper i ett befintligt segment, uppdateras inte faktiska populationsdata förrän 24 timmar efter att segmentet har skapats.
...
<table id="table_B24503F372E34B6BBDF5204181701A59"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Det uppskattade antalet unika besökare som har setts i realtid för det angivna tidsintervallet och som var kvalificerade för segmentet när de sågs av Audience Manager. </p> <p>I <span class="wintitle"> Segment Builder</span>, de 30 senaste populationerna för praktik (<span class="wintitle"> Totalt antal Trait-populationer</span>) kan vara annorlunda för egenskaper och segment som utvärderas i realtid. </p> <p>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Det uppskattade antalet unika besökare som kan finnas i ditt nya eller ändrade segment. Precis som med nästan alla uppskattningar garanterar inte tidigare prestanda framtida resultat, men du kan använda den beräknade summan för att: </p> <p> 
     ...
     </ul> </p> <p> <p>Obs! The <span class="wintitle"> Beräknad totalpopulation</span> mätvärdet inkluderar inte enheter som har kvalificerat sig för ett segment baserat på anslutningar från en <span class="wintitle"> Sammanfogningsregel för profil</span> som använder <a href="../../features/profile-merge-rules/merge-rule-definitions.md#device-options"> enhetsdiagram, alternativ</a>. </p> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
[!UICONTROL Profile Merge Rules] påverkar det faktiska antalet populationer i realtid och totalt antal. Dessa summor varierar beroende på om [!UICONTROL Profile Merge Rule] ett segment tillhör använder ett alternativ för enhetsdiagram eller inte. Se även [Alternativ för profilkopplingsregel definierade](../../features/profile-merge-rules/merge-rule-definitions.md).

### Segmentpopulationsdata för [!UICONTROL Merge Rules] Utan [!UICONTROL Device Graph Option]

I följande tabell definieras faktiska värden för populationen i realtid och totalt när dina segment används av en [!UICONTROL Profile Merge Rule] utan [!UICONTROL device graph] alternativ. Detta är inställningarna för enhetsalternativen **[!UICONTROL No Device Options]** och **[!UICONTROL Current Device Proflie]**.
...
<table id="table_A18C973855DB46A0B39B81F32E0E7540"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Det faktiska antalet unika besökare som har setts i realtid för det angivna tidsintervallet och som var kvalificerade för segmentet när de sågs av Audience Manager. </p> <p>I <span class="wintitle"> Segment Builder</span>, de 30 senaste populationerna för praktik (<span class="wintitle"> Totalt antal Trait-populationer</span>) kan vara annorlunda för egenskaper och segment som utvärderas i realtid. </p> <p> 
...
### Segmentpopulationsdata för [!UICONTROL Merge Rules] Med [!UICONTROL Device Graph] Alternativ

I följande tabell definieras faktiska värden för populationen i realtid och totalt när dina segment används av en [!UICONTROL Profile Merge Rule] skapat med [!DNL device graph] alternativ. Det här är enhetsalternativsinställningarna för [!UICONTROL Profile Link Device Graph], [!DNL Adobe] [!DNL device graph]och annan tredje part [!DNL device graph] alternativ som är tillgängliga för dig.
