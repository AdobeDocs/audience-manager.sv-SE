...
För att kunna använda [!DNL Google Ad Manager] (tidigare Google DFP) loggfiler i [!DNL Audience Manager]måste du först ange [Unikt användar-ID för Audience Manager (UUID)](../../../reference/ids-in-aam.md) i annonstagganropet. På så sätt inkluderas vårt ID i [!DNL Google Ad Manager] loggar och vi kan matcha ID:n mellan [!DNL Google Ad Manager] och [!DNL Audience Manager]. Använd [!DNL Audience Manager] [!UICONTROL DIL] eller [!UICONTROL Audience Management Module] för att ange [!DNL Audience Manager] UUID i en cookie för första part.

Så här anger du [!DNL Audience Manager] ID i annonstaggsanropet, vilket förklaras i vår dokumentation:
...
Du måste ange [!DNL Audience Manager] Identifiera dig själv och arbeta med [!DNL Audience Manager] konsulttjänster för att kontrollera om allt fungerar. Du har angett [!DNL Audience Manager] ID korrekt om:

* `'aamid'` är nyckeln som används som identifierare.
* Värdet för användar-ID är korrekt formaterat som [!DNL Audience Manager] UUID enligt vår [Index för ID:n i Audience Manager](../../../reference/ids-in-aam.md).
* Du har inkluderat [!DNL Audience Manager] UUID i ett definierat fält i [!DNL Google Ad Manager] loggar (t.ex. CustomTargeting).
...
<table id="table_C980A9F9B0FB4157B4908A64768B1571"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Bekräfta att stegen som krävs för att ställa in <span class="keyword"> Audience Manager</span> UUID (se ovan) har slutförts innan du går till steg 2 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Din Google Ad Manager-administratör tillhandahåller Google Ad Manager-nätverks-ID:t. Detta gör att vi kan skicka in nätverks-ID när vi anropar API:t. </p> </td> 
   <td colname="col3"> <p>Din Google Ad Manager-administratör </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Steg 6 </p> </td> 
   <td colname="col2"> <p>Kompilera förutsättningarna och öppna en supportanmälan genom att följa instruktionerna i detalj <a href="https://experienceleague.adobe.com/docs/customer-one/using/home.html">här</a> för att få igång processen för loggöverföring. </p> </td> 
   <td colname="col3"> <p>Du, eller <span class="keyword"> Audience Manager</span> Rådfråga dig </p> </td> 
  </tr> 
 </tbody> 
</table>
