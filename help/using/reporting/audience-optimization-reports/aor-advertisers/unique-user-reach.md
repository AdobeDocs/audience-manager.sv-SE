...
>Kom ihåg att:
>
>* The [!UICONTROL Unique User Reach] rapporten visar endast information för användare med [!UICONTROL Admin] behörighetsnivåer. Dina [!DNL Audience Manager] konsult eller kundtjänst kan tillhandahålla ditt konto hos [!UICONTROL Admin] behörigheter.
>
...
Dina [!UICONTROL Unique User Reach] skulle kunna se ut ungefär som nedan. Klicka på en bubbla i rapporten för att visa underliggande data.
