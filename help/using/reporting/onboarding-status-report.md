...
seo-title: Statusrapport om introduktion
solution: Audience Manager
title: Statusrapport om introduktion
...
>[!NOTE]
>
>Endast användare med administratörsbehörighet kan se den här rapporten i gränssnittet för Audience Manager. Du kan låta användare som inte är administratörer informeras om status för de överförda inkommande filerna genom att lägga till deras e-postmeddelanden i rapporten. Se [Ta emot e-postmeddelanden](/help/using/reporting/onboarding-status-report.md#receive-email-notifications).
...
Felrapportering och felsampling är två olika funktioner i [!UICONTROL Onboarding Status] rapporten.
...
>[!NOTE]
>
>Rapporten visar inte postfel i den aktuella versionen. Om du vill hitta och åtgärda filfel bör du granska resultaten och jämföra dem med specifikationerna i dokumentationen för [inkommande datafilinnehåll](../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md) .
...
A [!UICONTROL Sample Error Report] returnerar talposterna i en datakälla som har bearbetats och hur många som misslyckades. Följ de här stegen för att skapa en [!UICONTROL Sample Error Report].
...
<table id="table_1D44A2E6B4C847848B818190DD336841"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Listar filer som <span class="keyword"> Audience Manager</span> har tagit emot och bearbetat från den valda inkommande datakällan. </p> <p>Filbearbetning misslyckas om filnamnet är felaktigt formaterat. Vilka filnamn som krävs varierar beroende på hur du skickar dessa data till <span class="keyword"> Audience Manager</span>. Leveransmetoderna är bland annat <span class="keyword"> Amazon S3</span> och FTP. Instruktioner om hur du namnger filer finns i: </p> <p> 
...
<tr> 
   ...
   <td colname="col2"> <p>Visar antalet felaktigt formaterade globala enhets-ID:n. Se <a href="../reference/ids-in-aam.md">Index för ID i Audience Manager</a> och <a href="../features/global-data-sources.md">Global Data Sources</a> för mer information om hur enhets-ID ska formateras och vilka globala datakällor du ska använda, baserat på enhetstyp.</p>
...
<tr> 
   ...
   <td colname="col2"> <p>Dessa inbyggda ID:n <span class="keyword"> Audience Manager</span> kan inte matcha ett befintligt ID. Inbyggda ID:n kan ha den här statusen när <span class="keyword"> Audience Manager</span> ännu inte har utfört någon ID-synkronisering eller den fortfarande inte kan matcha ID:t även efter en synkronisering. </p> <p>För oöverträffade mobil-ID:n <span class="keyword"> kommer Audience Manager</span> att: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Visar egenskaper som <span class="keyword"> Audience Manager</span> inte kan matcha mot en viss egenskap. Detta kan bero på följande: </p> 
    <ul id="ul_43619035AB6641B6949302FB50BDB5B1"> 
     <li id="li_D4C6306BF2B143198108702B309CE8CF">Felaktigt formaterade egenskaper i den inkommande datafilen. Mer information om hur du formaterar datafilen finns i Innehåll i <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> inkommande datafil: Syntax, Variables och Examples</a>. </li> 
     <li id="li_A1C708A007D24EE09B7C629AFC6E43C3">Traits that have not been defined in Audience Manager <span class="keyword"></span>. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Totalt antal oanvända signaler som tagits emot i rapporten. Summan baseras på det totala antalet poster som lagrats. </p> <p>Mer information finns i rapporten <a href="../reporting/dynamic-reports/unused-signals.md"></a> om oanvända signaler. </p> </td> 
  </tr> 
 </tbody> 
</table>
