...
<tr> 
   ...
   <td colname="col2"> <p>Visar antalet felaktigt formaterade globala enhets-ID:n. Se <a href="../reference/ids-in-aam.md">Index för ID:n i Audience Manager</a> och <a href="../features/global-data-sources.md">Global Data Sources</a> för mer information om hur enhets-ID ska formateras och vilka globala datakällor du ska använda, baserat på enhetstyp.</p>
...
<tr> 
   ...
   <td colname="col2"> <p>Dessa ID:n <span class="keyword"> Audience Manager</span> kan inte matcha ett befintligt ID. Inbyggda ID:n kan ha den här statusen när <span class="keyword"> Audience Manager</span> ännu inte har utfört någon ID-synkronisering eller den fortfarande inte kan matcha ID:t även efter en synkronisering. </p> <p>För oöverträffade mobil-ID:n kommer <span class="keyword"> Audience Manager</span> att </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Visar egenskaper som <span class="keyword"> Audience Manager</span> inte kan matcha mot en viss egenskap. Detta kan bero på följande: </p> 
    <ul id="ul_43619035AB6641B6949302FB50BDB5B1"> 
     ...
     <li id="li_A1C708A007D24EE09B7C629AFC6E43C3">Fällor som ännu inte har definierats i <span class="keyword"> Audience Manager</span>. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
