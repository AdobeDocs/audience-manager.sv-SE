...
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Modellkloning för prediktiva målgrupper**: Nu kan du klona befintliga modeller och ändra deras konfiguration utifrån dina behov. Läs [Kloning and Editing Predictive Audience Models](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) om du vill ha mer information.</li><li>**Batchklassificering** för prediktiva målgrupper: Förutom att klassificera besökare i distinkta personligheter i realtid har Predictive Audiences nu stöd för gruppklassificering, vilket hjälper er att klassificera onboardanvändare och aktivera för gruppdestinationer.</li></ul> |
| [Överlappa rapporter](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Vi har uppdaterat den metod vi använder för att beräkna överlappningsrapporter ([Trait-to-Trait](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-to-Trait](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment-till-Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). Beräkningen av överlappningsrapporter baseras nu på rapportuniviteter och MinHash-signaturer (i stället för [1/54 datamaterial](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| [Inkommande S3-](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) filnamn och  [inkommande FTP-filnamn](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Vi uppdaterade definitionerna och gav exempel för fälten `DPID` och `DPID_TARGET_DATA_OWNER` i filnamnssyntaxen. |

## Augusti 2020 {#aam-august-updates}

| Hjälpavsnitt | Beskrivning |
|---- |----|
| [Google kundmatchning för personbaserade destinationer](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Du kan nu använda [!UICONTROL People-Based Destinations] för att rikta in användare via [!DNL Google Customer Match]. Innan du kan använda [!UICONTROL People-Based Destinations] för att skicka egna målgruppssegment till ett [!DNL Google Customer Match]-mål måste du läggas till i tillåtelselista. [!DNL Google] Mer information finns i dokumentationen för [Personbaserade mål](../features/destinations/people-based-destinations-prerequisites.md#gcm). |
| [Nya SFTP-servrar](../faq/faq-data-collection.md) | Nu kan du använda de nya [!DNL SFTP]-servrarna ([!DNL ftp-in-gtw] och [!DNL ftp-out-gtw]) som använder [!DNL AWS SFTP Gateway] över [!DNL S3]. |
