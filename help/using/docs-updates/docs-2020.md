...
| Hjälpavsnitt | Beskrivning |
|---- |----|
| [Målgruppsdelning mellan Audience Manager och Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | I det nya avsnittet, **Förstå skillnader i segmentpopulationer mellan Audience Manager och Experience Platform**, beskrivs möjliga orsaker till varför antalet populationer kan variera mellan Experience Platform och Audience Manager. |
| [Komma igång med Audience Manager REST API:er](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Vi lade till ett nytt avsnitt, **JWT-autentisering (tjänstkonto) med[!DNL Adobe I/O]**. I det här avsnittet kan du autentisera Audience Manager API:er med [!DNL Adobe I/O]. |

## Juni 2020 {#aam-june-updates}

| Hjälpavsnitt | Beskrivning |
|---- |----|
| [Stöd för Audience Manager Data Export Control i Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aam-data-export-control-in-aep) | Det nya avsnittet i artikeln Målgruppsdelning mellan Audience Manager och Adobe Experience Platform innehåller en mappning mellan Audience Manager dataexportkontroller och Experience Platform etiketter för dataanvändning. |
| [Plugin-program för Audience Manager för IAB TCF](../overview/data-security-and-privacy/aam-iab-plugin.md) | Adobe fokuserar fortfarande på sekretess via design och vi uppgraderar Audience Manager Plug-in för IAB TCF till IAB Transparency &amp; Consent Framework (TCF) version 2.0 från och med 10 juni 2020. Kunder som har implementerat Audience Manager Plug-in för IAB TCF måste uppgradera till version 2.0 före 15 augusti 2020 för att kunna fortsätta använda funktionen. Efter 15 augusti 2020 kommer version 1.1 att bli inaktuell och stöds inte längre. |
