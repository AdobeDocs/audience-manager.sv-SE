...
| [Nya SFTP-servrar](../faq/faq-data-collection.md) | Nu kan du använda de nya [!DNL SFTP] servrarna (`ftp-in-gtw` och `ftp-out-gtw`) som använder [!DNL AWS SFTP Gateway] över [!DNL S3]. |
