---
description: En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2016. Innehåller mindre uppdateringar eller ändringar av Audience Manager-guiden som kanske inte ingår i versionsinformationen för Experience Cloud.
seo-description: En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2016. Innehåller mindre uppdateringar eller ändringar av Audience Manager-guiden som kanske inte ingår i versionsinformationen för Experience Cloud.
seo-title: Dokumentationsuppdateringar för 2016
...
En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2016. Innehåller mindre uppdateringar eller ändringar av Audience Manager-guiden som kanske inte ingår i versionsinformationen för Experience Cloud.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../dil/dil-use-cases.md#traffic-dil-gtm"> Trafik-DIL i Google Tag Manager (GTM) </a> </p> </td> 
   <td colname="col2"> <p>Efter en Google-uppdatering i maj 2016 kan du läsa in DIL-kod i den anpassade HTML-delen av en tagg. Du behöver inte längre vara fjärrvärd för koden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-data-collection.md"> Vanliga frågor om datainsamling och produktintegrering </a> </p> </td> 
   <td colname="col2"> <p>Innehåller en ny post om IP- och FTP-adresserna för Audience Manager <span class="keyword"> i vitlistan</span> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dokumentation som beskriver en ny DIL-metod som gör att du kan skicka data till <span class="keyword"> Audience Manager</span> från Googles Universal Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Frågor och svar om <span class="wintitle"> Audience Lab</span> -funktionen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/destinations/destinations-home.md"> Startsida för mål </a> </p> </td> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Lagt till funktioner för att skydda din utgående dataöverföring i realtid via OAuth 2.0-protokollet. Kontakta din Adobe Audience Manager <span class="keyword"></span> -konsult för att komma igång. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reviderad för att notera att den <code> GA.init()</code> inte fungerar med den senaste versionen av Googles analyskod <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rule-definitions.md"> Alternativ för profilkopplingsregel definierade </a> </p> </td> 
   <td colname="col2"> <p>Reviderad för att inkludera mer information om Adobe Experience Cloud Device Co-op <span class="keyword"></span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookies som används i Experience Cloud</a> </td> 
   <td colname="col2"> Ändrade demonstrationscookie och partnercookiens TTL-värde (time-to-live) till 180 dagar för att uppfylla franska CNIL-regler. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../dil/dil-overview.md"> Understanding the Data Integration Library (DIL) </a> </td> 
   <td colname="col2">En allmän översikt över <span class="wintitle"> DIL (Data Information Library</span> ). </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> Målinriktning på enheter med plattformsnivå </a> </td> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reference/bulk-management-tools/bulk-management-intro.md"> Komma igång med masshantering </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uppdaterade rapporten <span class="wintitle"> Audience</span>Optimization Reports with Cross Channel Conversion, Role-Based Access Control, Conversion Groups, and the Reported Conversion Traits. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Med alternativet <span class="wintitle"> Konvertera</span> över flera kanaler i rapporten <span class="wintitle"> Målgruppsoptimering</span> kan du attribuera offlinekonverteringar till serverade onlinevisningar eller -klick. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/traits/trait-geotarget-keys.md"> Geogeting med tangenter på plattformsnivå </a> </p> </td> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Borttagen från <span class="keyword"> Audience Manager</span> -dokumentationen i september 2017. Flyttad till <span class="keyword"> Analytics</span> -dokumentation. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/profile-link-metrics.md"> Rapportera mått för profilkopplingsregler </a> </p> </td> 
   <td colname="col2"> <p>Ny dokumentation definierar rapportvärden och diagram för profilsammanslagning. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobe.com/content/help/en/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Audience Manager-segment i analys</a> </p> </td> 
   <td colname="col2"> <p>Dela Audience Manager-segment med Analytics i realtid. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/destinations/destinations.md"> Mål </a> </p> </td> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Beskriver hur <span class="wintitle"> DataProvider på Audience Marketplace</span> inaktiverar en prenumerations feed. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> Vad som händer efter att en leverantör har inaktiverat min datafeed </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>Reviderad text som inkluderar <code> d_mid</code> variabeln. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En ny beskrivning av <span class="wintitle"> händelsetypen</span>har lagts till. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Ny dokumentation som listar och definierar objekten i en <span class="wintitle"> faktureringsrapport för Audience Marketplace</span> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#marketplace-buyer-details"> Förstå sidan med avtalsinformation på Audience Marketplace </a> </p> </td> 
