...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>För kunder som använder Audience Manager och Adobe Analytics: Med användargränssnittet i Audience Manager kan du inte ta bort datakällor som skapas automatiskt från dina Analytics-rapportsviter. Använd bastjänsten <a href="https://experienceleague.adobe.com/docs/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external"> </a> för att ta bort mappningen för dessa datakällor. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Förstå Datan Integration Library (DIL)</a> </p> </td> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>I juni 2018 tar Adobe bort stödet för TLS 1.0-protokollet. Adobe Audience Manager-funktionalitet fungerar inte för slutanvändare som bara har stöd för TLS 1.0. Vi har samlat in en lista över webbläsare, versioner och TLS-stöd åt dig. </p> </td> 
  </tr> 
  <tr> 
