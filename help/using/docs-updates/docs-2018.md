...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Vi har uppdaterat dokumentationen så att den innehåller de nya sök- och filtreringsfunktionerna för testgrupper. Se <a href="../features/audience-lab/audience-lab.md#search-and-filter"> Sök efter och filtrera testgrupper</a> -avsnitt. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-data-action.md"> IRIS-optimeringar</a> </p> </td> 
   <td colname="col2"> <p>Se <b>Regler för segmentmappning</b> för mer information om den uppsättning regler som IRIS följer när segment skickas till destinationer. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Från och med version 8.0, <span class="wintitle"> DIL</span> är beroende av <a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, version 3.3 eller senare. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Förstå Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Ändrad <a href="../dil/dil-overview.md"> Hämta och implementera DIL-kod</a> för att ta hänsyn till att <span class="keyword"> Adobe Experience Platform Launch</span> är det bästa koddistributionsverktyget i <span class="keyword"> Experience Cloud</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../dil/dil-class-overview/dil-create.md#dil-create"> Skapa DIL</a> </td> 
   <td colname="col2"> <p>Följande element är inaktuella från och med <span class="wintitle"> DIL</span> 8.0, släppt augusti 2018: </p> <p> 
...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Från och med 29 mars 2018 finns alla Audience Manager-kunder på <a href="https://www.ampproject.org/learn/overview/" format="https" scope="external"> Accelererade mobilsidor</a> (AMP) måste utnyttja integreringen på serversidan när målgrupper skickas till Google DoubleClick for Publishers (DFP). </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Användarna börjar kvalificera sig för en regelbaserad trait ungefär 4 timmar efter att du gjort det <a href="../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits"> skapa EGENSKAPEN</a> i användargränssnittet. Läs dokumentet om du vill ha mer information om kvalificering av trait. </p> </td> 
  </tr> 
  <tr> 
