...
| Hjälpavsnitt | Beskrivning |
|--- |----|
| [Startsida för destinationer](/help/using/features/destinations/destinations-home.md) | Startsidan [Destinations](https://bank.demdex.com/portal/destinations/all) har ett nytt utseende. Läs den här sidan för information om den nya layouten. |
