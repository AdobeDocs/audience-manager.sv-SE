...
| [Konfigurera Twitter skräddarsydda målgrupper som självbetjäningsbaserade enhetsbaserade mål](../features/destinations/twitter-tailored-audiences.md) | Vi migrerar Twitter-destinationer till en modell för självbetjäningskonfiguration. I den här artikeln beskrivs vad du behöver göra för att befintliga Twitter-integreringar ska kunna fortsätta arbeta efter migreringen. |
