...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#cost-attribution"> Fakturering och Impression-allokering för CPM-datafeeds </a> </p> </td> 
...
<table id="table_285A1E3D41F245D195FC983A298F89DA"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1">Metoden <a href="../dil/dil-class-overview/dil-create.md#dil-create"> create</a> i DIL. </td> 
   <td colname="col2"> <p> 
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Kundaktivering för profilsammanslagning </p> </td> 
   <td colname="col2"> <p>Ytterligare steg har lagts till för att förklara hur du lägger till deklarerade ID:n i DIL och Mobile SDK:n. </p> <p>Det här dokumentet har tagits bort och ersatts av <a href="../features/profile-merge-rules/merge-rules-start.md"> Skapa en Source för enhetsövergripande data </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> Innehåll i inkommande datafil: Syntax, Variables, and Examples </a> </p> </td> 
