---
description: En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2015. Innehåller mindre uppdateringar eller ändringar av Audience Manager-guiden som kanske inte ingår i versionsinformationen för Experience Cloud.
seo-description: En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2015. Innehåller mindre uppdateringar eller ändringar av Audience Manager-guiden som kanske inte ingår i versionsinformationen för Experience Cloud.
...
En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2015. Innehåller mindre uppdateringar eller ändringar av Audience Manager-guiden som kanske inte ingår i versionsinformationen för Experience Cloud.
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Audience Manager</span> sätter en maxgräns för antalet egenskaper, segment, mål och algoritmiska modeller som du kan skapa för ett konto. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Textändringar och uppdateringar. Dessutom ingår nya nyckelvärdepar som krävs för att använda och se läsbara datanamn i <span class="wintitle"> Advertising Analytics</span> -rapporterna. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/click-data-pixels.md"> Samla in data för kampanjklickningar via pixelanrop </a> </p> </td> 
   <td colname="col2"> <p>Textändringar och uppdateringar. Dessutom ingår nya nyckelvärdepar som krävs för att använda och se läsbara datanamn i <span class="wintitle"> Advertising Analytics</span> -rapporterna. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Använd era<span class="keyword"> data från DoubleClick Campaign Manager</span> i <span class="keyword"> Audience Manager</span>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../api/dcs-intro/dcs-event-calls/dcs-event-calls.md"> API-metoder och -kod för Data Collection Server (DCS)</a> </td> 
...
<table id="table_E3544AE9796D43408FBEC64CA5B493D8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Med Audience Marketplace kan dataleverantörer och köpare utföra dataaffärer på självbetjäningssätt med minimal insats. Det gör man genom att erbjuda specialfunktioner som varierar beroende på din roll som datamedare eller dataförsäljare. </td> 
  </tr> 
  <tr> 
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nytt ämne. </p> <p>Ändrad till Vanliga frågor <a href="../faq/faq-privacy.md"></a> om sekretess och datalagring (12/2016). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uppdaterad text och tillagda illustrationer. </p> <p>Det här dokumentet har tagits bort och ersatts av <a href="../features/profile-merge-rules/merge-rules-overview.md"> Profile Link</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/recency-and-frequency.md"> Nyhet och frekvens </a> </p> </td> 
