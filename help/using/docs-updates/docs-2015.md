...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Audience </span> Managers anger en maxgräns för antalet egenskaper, segment, mål och algoritmiska modeller som du kan skapa för ett konto. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_3A725D1D52D24CEAB49B10814008F1C7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>Reviderad text som inkluderar nyckelvärdepar för <code> d_cid</code> och <code> d_cid_ic</code>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Textändringar och uppdateringar. Dessutom ingår nya nyckelvärdepar som krävs för att använda och läsbara datanamn ska visas i <span class="wintitle"> Advertising Analytics</span>-rapporterna. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> </span> Analyskunder måste ange en integrationskod när de använder den Överordnad marknadsföringsprofilen och skickar deklarerade ID:n via Visitor ID-tjänsten till  <span class="keyword"> Audience Manager</span>. </p> <p>Det här dokumentet är föråldrat och har ersatts med <a href="../features/profile-merge-rules/merge-rules-start.md"> Skapa en datakälla mellan enheter</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_285A1E3D41F245D195FC983A298F89DA"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1">Metoden DIL <a href="../dil/dil-class-overview/dil-create.md#dil-create"> create</a>. </td> 
   <td colname="col2"> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Följande information har lagts till i avsnittet Begränsningar och regler: </p> <p> 
     <ul id="ul_2451A3EAA05E4961AA7EA90026F353F5"> 
      ...
      <li id="li_F957554820B6454FA9756267C4D09AAD"> <p>När du vill att kraven på aktuell tid/frekvens ska vara mindre än ett visst antal gånger eller dagar, måste du koppla den egenskapen till en annan med operatorn AND. </p> <p>Med hjälp av ovanstående exempel, <code> frequency([1000T]) &lt;= 5</code>, blir uttrycket giltigt när det kopplas till en annan egenskap. </p> <p>Exempel: </p> <p> <code> frequency([1000T]) &lt;= 5 AND isSiteVisitorTrait</code> </p> </li> 
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Avsnittet som förklarar hur tal i <span class="wintitle"> allmänna rapporter</span> genereras har lagts till. </p> </td> 
  </tr> 
  <tr> 
