---
description: En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2015. Innehåller mindre uppdateringar eller ändringar av Audience Manager-handboken som kanske inte finns med i versionsinformationen för Experience Cloud.
...
# Dokumentationsuppdateringar 2015 {#documentation-updates}

En lista över ny och reviderad Audience Manager-dokumentation som släpptes 2015. Innehåller mindre uppdateringar eller ändringar av Audience Manager-handboken som kanske inte finns med i versionsinformationen för Experience Cloud.
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#cost-attribution"> Fakturerings- och impressionsallokering för CPM-datafeeds </a> </p> </td> 
   <td colname="col2"> <p>Instruktioner om hur du tilldelar avbildningar för olika CPM-dataflöden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md"> Fakturerings- och impressionsallokering för statiska avgiftsdatafeeds </a> </p> </td> 
...
<table id="table_3A725D1D52D24CEAB49B10814008F1C7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Uppdatera koden så att den använder <code> d_cid</code> eller <code> d_cid_ic</code> i stället för <code> d_dpid</code> och <code> d_dpuuid</code>. DPID- och DPUID-variablerna fortsätter att fungera, men du bör tänka på att de är inaktuella. Detta inkluderar DPID- och DPUID-varianter utan prefixet <code> d_</code>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>Reviderad text som inkluderar nyckelvärdepar <code> d_cid</code> och <code> d_cid_ic</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/declared-ids.md#declared-id-targeting"> Deklarerat ID-mål </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-private-feeds.md"> privata datafeeds </a> </p> </td> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Format och innehållskrav för att hämta data till <span class="wintitle"> Audience Optimization</span> -rapporterna. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Textändringar och uppdateringar. Dessutom inkluderades nya nyckelvärdepar som krävs för att använda och läsbara datanamn ska kunna visas i <span class="wintitle"> Advertising Analytics</span> -rapporterna. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/click-data-pixels.md"> Samla in kampanjklicksdata via pixelanrop </a> </p> </td> 
   <td colname="col2"> <p>Textändringar och uppdateringar. Dessutom inkluderades nya nyckelvärdepar som krävs för att använda och läsbara datanamn ska kunna visas i <span class="wintitle"> Advertising Analytics</span> -rapporterna. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/bulk-management-tools/bulk-management-intro.md"> Masshanteringsverktyg </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <a href="../integration/integration-other-solutions/audience-management-module.md"> Implementera Audience Management Module</a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Kunder som använder <span class="keyword"> Analytics</span> måste ange en integreringskod när de använder huvudmarknadsföringsprofilen och skickar deklarerade ID:n via Visitor ID-tjänsten till <span class="keyword"> Audience Manager</span>. </p> <p>Det här dokumentet är inaktuellt och har ersatts av <a href="../features/profile-merge-rules/merge-rules-start.md"> Skapa ett Source-dokument för korsenhetsdata </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md"> Vanliga frågor om rapportering </a> </p> </td> 
   <td colname="col2"> <p>En ny post med vanliga frågor och svar förklarar varför, ibland, nyligen införda egenskaper inte visas i <span class="wintitle"> Trait Graph </span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Hämta dina <span class="keyword"> DoubleClick Campaign Manager</span>-data till <span class="keyword"> Audience Manager</span>. </td> 
  </tr> 
  <tr> 
   <td colname="col1">API-metoder och kod för <a href="../api/dcs-intro/dcs-event-calls/dcs-event-calls.md">-datainsamlingsserver (DCS) </a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      <li id="li_9C29F2E224444AC5B77B69C3BC9B26A8">Den valfria parametern <code> iframeAttachmentDelay</code> har tagits bort. </li> 
      <li id="li_85A63519222A4423B8D7A3FF90929741">En anteckning har lagts till i variabeln <code> declaredId</code>. När du använder besökar-ID-tjänsten anger du ID:t med <code> setCustomerIDs</code> i stället för DIL. Se <a href="https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html?lang=sv-SE" format="https" scope="external"> Kund-ID och autentiserade tillstånd</a>. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E3544AE9796D43408FBEC64CA5B493D8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Audience Marketplace gör det möjligt för dataleverantörer och köpare att utföra dataaffärer på ett självbetjäningssätt med minsta möjliga ansträngning. Det gör man genom att erbjuda specialfunktioner som varierar beroende på din roll som datamedare eller dataförsäljare. </td> 
  </tr> 
  <tr> 
...
<table id="table_E8CD8CF9B9D3439C99AC688AFD712621"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> Innehåll i inkommande datafil: Syntax, Variables, and Examples </a> </p> </td> 
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md"> Vanliga frågor om rapportering </a> </p> </td> 
   <td colname="col2"> <p>Nya vanliga frågor och svar har lagts till som förklarar varför antalet lyckade bearbetade poster kan skilja sig åt när du jämför inkommande kvitto och rapportering i AAM. </p> <p>En ny FAQ har lagts till som förklarar varför fackuniskerna för mina medföljande traits är högre än det totala antalet onboardposter. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-overview.md"> Systemkomponenter </a> </p> </td> 
...
<table id="table_14B4E7BC63394E1F966035B977F90D58"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/reporting-file-transfer-timeframe.md"> Riktlinjer för rapportering och filöverföring för tidsram </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/recency-and-frequency.md"> Tid och frekvens </a> </p> </td> 
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-inbound-data-ingestion.md"> Inkommande CRM-datainmatning </a> </p> </td> 
   <td colname="col2"> <p>Tydligare är hur lång tid det tar att sprida inkommande data till kanten. </p> <p>Avsevärt redigerat ämne. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/reports-dashboard.md"> Kontrollpanel </a> </p> </td> 
   <td colname="col2"> <p>Nytt hjälpavsnitt. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ett valfritt tillägg som inte innehåller personligt identifierbar information har lagts till. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md"> Vanliga frågor om rapportering </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>Kundaktivering för profilsammanslagning </p> </td> 
   <td colname="col2"> <p>Ytterligare steg har lagts till för att förklara hur du lägger till deklarerade ID:n i DIL och Mobile SDK. </p> <p>Det här dokumentet har tagits bort och ersatts av <a href="../features/profile-merge-rules/merge-rules-start.md"> Skapa en Source för enhetsövergripande data </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> Innehåll i inkommande datafil: Syntax, Variables, and Examples </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uppdaterad text och nya illustrationer. </p> <p>Det här dokumentet har tagits bort och ersatts av <a href="../features/profile-merge-rules/merge-rules-overview.md"> profillänk </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/recency-and-frequency.md"> Tid och frekvens </a> </p> </td> 
