...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>I referenssyfte har vi lagt till de reserverade attributen <code> d_dst_filter</code> och <code> d_rs</code> till dokumenterade <code> d_</code> attribut. Vi rekommenderar att du inte skapar egenskaper som använder reserverade attribut. Adobe kan när som helst ändra reserverade attribut. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Attribut som stöds för DCS API-anrop</a> </p> </td> 
   <td colname="col2"> <p>Tillagd <code> d_cts</code> som en valfri parameter i listan med tillgängliga nycklar för DCS-begäranden. Du måste kontakta din Adobe Audience Manager-konsult eller kundtjänst för att aktivera den. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Steg 7 har lagts till om vad du behöver göra för att aktivera <span class="wintitle"> Åtgärdsbara loggfiler</span> efter inställning av DCM-datafilimport till <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> The <b><span class="uicontrol"> Redigera</span></b> arbetsflödet gör att du kan ändra datakällan för mappegenskaper. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Trait- och segmentpopulationsdata i Segment Builder</a> </p> </td> 
   <td colname="col2"> <p>Ändrade ett mätvärde till <span class="wintitle"> Population för totalt fack</span> från <span class="wintitle"> Unika kundrelationer</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ett nytt avsnitt i vår dokumentation som belyser flera användningsfall för <span class="wintitle"> Audience Lab</span> -funktion. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Du kan använda flera olika typer och källor av modeller i <span class="keyword"> Audience Manager</span>. <span class="wintitle"> Audience Lab</span> erbjuder ett enkelt sätt att jämföra kundernas konverteringsgrader i alla era aktiva modeller. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Använd <span class="wintitle"> Audience Lab</span> för att mäta hur många konverteringar en kreatör kör mellan olika destinationer. I det här exemplet kan du även mäta konverteringarna av den kreativa bilden mot naturligt förekommande konverteringar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> Vanliga frågor om regler för profilsammanslagning</a> </p> </td> 
   <td colname="col2"> <p>Nya vanliga frågor och svar har lagts till <span class="wintitle"> Sammanfogningsregel för profil</span> och frågor om enhetsdiagram. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>DCS HTTP-svarsanrop innehåller nu <code> tid</code> fält. Använd det här fältet i felsökningssyfte vid incidenter. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>Lade till en kommentar som klargör att 7-dagars och 30-dagars summeringsperioder endast är tillgängliga för söndag <b><span class="uicontrol"> Datum till</span></b> datum. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reviderat innehåll för att ange följande: </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">Filerna måste vara gzip-komprimerade och ha en <code> .gz</code> filtillägg. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Trait- och segmentpopulationsdata i Segment Builder</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Lagt till ett nytt dokument om varför <span class="keyword"> Audience Manager</span> ringer <code> demdex.net</code> domän. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Audience Manager Cookies</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ytterligare sök- och filterfunktioner har lagts till i <b><span class="uicontrol"> Bläddra bland alla egenskaper</span></b> avancerad sökning. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Det här avsnittet innehåller nytt och reviderat innehåll som stöder <span class="wintitle"> Profillänk</span> och alternativ för enhetsdiagram från tredje part. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Element för valfritt filnamn har lagts till <code> PID-ALIAS</code> i den utgående filen. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reviderad beskrivning och tillagda relaterade länkar till <code> containerSNID</code> egenskap för <code> DIL.create</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> Målgruppsstatistik</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uppdaterat med förväntat format för mobila enhets-ID:n (DAID) som hanteras av <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En ny post som beskriver <span class="keyword"> Experience Cloud</span> <span class="wintitle"> Organisations-ID</span>, inklusive information om hur du hittar den. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
   ...
   <td colname="col2"> <p>Uppdaterat för att inkludera <code> DPUUIDS</code> makro. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Länkar till [!DNL Audience Manager] versionsinformation och dokumentationsändringar. Om du vill arkivera äldre ändringar på [!DNL Experience Cloud] nivå, se [Tidigare versionsinformation](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) -avsnitt.
