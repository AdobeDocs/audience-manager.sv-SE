...
<table id="table_366914EEDA294636A580F706AFC57ACC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/en_US/whitepapers/cookies/cookies_am.html" format="https" scope="external"> Cookies för Audience Manager</a> </p> </td> 
...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-qualification-reference.md"> Referens för dragningskvalitet</a> </p> </td> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Attribut som stöds för DCS API-anrop</a> </p> </td> 
   <td colname="col2"> <p>Tillagd <code> d_cts</code> som en valfri parameter i listan över tillgängliga nycklar för DCS-begäranden. Du måste kontakta din Adobe Audience Manager-konsult eller kundtjänst för att aktivera den. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../reference/reporting-file-transfer-timeframe.md"> Hur dataleverans och bearbetningstider påverkar rapporter</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Du kan skicka data till DCS med hjälp av metoderna GET eller POST. I det här dokumentet beskrivs syntaxen som du måste använda i varje enskilt fall. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-reporting.md"> Vanliga frågor om rapportering</a> </p> </td> 
   <td colname="col2"> <p>Total Trait Fires har bytt namn till Total Trait Realizations i gränssnittet i Audience Manager. Vi uppdaterade de vanliga frågorna för att återspegla den här ändringen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/destinations/create-analytics-destination.md"> Konfigurera ett analysmål</a> </p> </td> 
   <td colname="col2"> <p>Nytt innehåll om hur du skickar segment för Audience Manager till Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/media-data-integration/actionable-log-files.md"> Åtgärdsbara loggfiler</a> </p> </td> 
   <td colname="col2"> <p>Ta reda på varför <span class="wintitle"> loggfiler</span> som går att använda kan vara det rekommenderade sättet att importera DCM-loggfiler till <span class="keyword"> Audience Manager</span> och se hur du kommer igång med funktionen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-details-page.md"> Anpassa detaljsida</a> </p> </td> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-event-calls/dcs-event-calls.md"> API-metoder och -kod för Data Collection Server (DCS)</a> </p> </td> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Instruktioner om hur du tar bort egenskaper från ett segment med hjälp av <span class="wintitle"> Segment Builder</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"><a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md"> Krav för Amazon S3-namn och filstorlek för inkommande data..</a> </td> 
   <td colname="col2"> <p>Vi har ökat den dokumenterade optimala och maximala filstorleken för komprimerade filer. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"><a href="../features/traits/trait-geotarget-keys.md"> Geogeting med tangenter på plattformsnivå</a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ett nytt avsnitt i vår dokumentation som belyser flera användningsfall för <span class="wintitle"> Audience Lab</span> -funktionen. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Du kan använda flera olika typer och källor med modeller i <span class="keyword"> Audience Manager</span>. <span class="wintitle"> Audience Lab</span> är ett enkelt sätt att jämföra kundernas konverteringsgrader i alla era aktiva modeller. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Använd <span class="wintitle"> Audience Lab</span> för att mäta antalet konverteringar en kreatör kör mellan olika destinationer. I det här exemplet kan du även mäta konverteringarna av den kreativa bilden mot naturligt förekommande konverteringar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> Vanliga frågor om regler för profilsammanslagning</a> </p> </td> 
   <td colname="col2"> <p>En ny FAQ har lagts till som svar på vanliga frågor om <span class="wintitle"> sammanfogningsregel</span> och enhetsdiagram. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>DCS HTTP-svarsanrop innehåller nu <code> tid</code> fältet. Använd det här fältet i felsökningssyfte vid incidenter. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/batch-data-transfer-overview.md"> Skicka gruppdata till Audience Manager - översikt</a> </p> </td> 
   <td colname="col2"> <p>Ytterligare information om platser för produktions- och betaversionen av Amazon S3-tjänsten. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>En kommentar som klargör att 7-dagars och 30-dagars summeringsperioder endast är tillgängliga för <b><span class="uicontrol"> datumdatumen</span></b> för söndag. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/recency-and-frequency.md"> Nyhet och frekvens</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/metadata-files-intro/datafiles-intro.md"> Datafiler för målgruppsoptimeringsrapporter</a> </p> </td> 
   <td colname="col2"> <p>Reviderat innehåll för att ange följande: </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">Filerna måste vara gzip-komprimerade och ha ett <code> .gz</code> filtillägg innan de kan överföras. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Trait and Segment Population Data in Segment Builder</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ett nytt dokument har lagts till om varför <span class="keyword"> Audience Manager</span> gör anrop till <code> demdex.net</code> domänen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/en_US/whitepapers/cookies/cookies_am.html" format="https" scope="external"> Cookies för Audience Manager</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Attribut som stöds för DCS API-anrop</a> </p> </td> 
   <td colname="col2"> <p>Uppdaterade nyckelvariabelprefixen med <code> _p</code>att identifiera privata parametrar i Audience Manager. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ytterligare sök- och filterfunktioner har lagts till i den avancerade sökningen i <b><span class="uicontrol"> Sök alla egenskaper</span></b> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Det här avsnittet innehåller nytt och reviderat innehåll som stöder alternativen för <span class="wintitle"> Profile Link</span> och enhetsdiagram från tredje part. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Ett valfritt filnamnselement har lagts till <code> PID-ALIAS</code> i den utgående filen. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/en_US/mcloud/dns-prefetch.html" format="https" scope="external"> Använda DNS-förhämtning med olika Experience Cloud-lösningar</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/rest-api-main/aam-api-folders.md"> Metoder för mapp-API</a> </p> </td> 
   <td colname="col2"> <p>Skrivs om i Swagger och migreras till en ny plats. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../api/rest-api-main/api-traits.md"> Metoder för Trait API</a> </p> </td> 
   <td colname="col2"> <p>Skrivs om i Swagger och migreras till en ny plats. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/audience-optimization-reports.md"> Målgruppsoptimeringsrapporter</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uppdaterat med det förväntade formatet för mobila enhets-ID:n (DAID) som hanteras av <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md"> Krav för Amazon S3-namn och filstorlek för inkommande data..</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En ny post som beskriver <span class="keyword"> Experience Cloud</span> <span class="wintitle"> Organization ID</span>har lagts till, inklusive information om hur du hittar det. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
   ...
   <td colname="col2"> <p>Uppdaterat för att inkludera <code> DPUUIDS</code> makrot. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Länkar till [!DNL Audience Manager] versionsinformation och dokumentationsändringar före 2017. En arkiv med äldre ändringar på [!DNL Experience Cloud] nivå finns i [föregående versionsinformation](https://marketing.adobe.com/resources/help/en_US/whatsnew/?f=c_legacy_releases.html).
