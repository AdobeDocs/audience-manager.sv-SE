...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Total Trait Fires har bytt namn till Total Trait Realizations i Audience Manager användargränssnitt. Vi har uppdaterat de vanliga frågorna för att återspegla den här ändringen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html?lang=sv-SE" format="https" scope="external"> Använda DNS-förhämtning med olika Experience Cloud-lösningar</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/api-swagger-migration.md"> Audience Manager API-kodmigrering</a> </p> </td> 
