...
+ Översikt{#overview}
   ...
   + Dataintegritet {#data-privacy}
      + [Översikt över dataintegritet](overview/data-security-and-privacy/data-privacy.md)
      + [Begäranden om dataintegritet](overview/data-security-and-privacy/data-privacy-requests.md)
      + Referens för datasekretess {#data-privacy-reference}
         ...
         + [GDPR:s beredskapsvägledning för Audience Manager-kunder](overview/data-security-and-privacy/aam-gdpr-readiness.md)
      + Hantering av samtycke {#consent-management}
         + [Hantering av samtycke](overview/data-security-and-privacy/data-privacy-consent.md)
         + [Plugin-programmet Audience Manager för IAB TCF](overview/data-security-and-privacy/aam-iab-plugin.md)
...
+ Funktioner{#features}
   ...
   + Administration{#administration}
      ...
      + [IP-adressofuscation](features/administration/ip-obfuscation.md)
   ...
   + Datautforskaren{#data-explorer}
      + [Data Explorer - Översikt, fördelar och användningsfall](features/data-explorer/data-explorer-overview.md)
      ...
      + Signalsökning{#signals-search}
         ...
         + [Sök signaler efter filter](features/data-explorer/data-explorer-signals-search/data-explorer-search-filters.md)
   ...
   + Mål {#destinations}
      + [Destinationsöversikt](features/destinations/destinations.md)
      + [Startsida för mål](features/destinations/destinations-home.md)
      + Destinationer för Adobe Experience Cloud{#experience-cloud-destinations}
         + [Konfigurera ett Analytics-mål](features/destinations/create-analytics-destination.md)
      ...
      + Enhetsbaserade mål (server-till-server) {#device-based}
         ...
         + [Konfigurera Twitter-anpassade målgrupper som självbetjäningsbaserade enhetsbaserade mål](features/destinations/twitter-tailored-audiences.md)
      ...
      + Destinationsreferens {#destinations-reference}
         ...
         + [Standard- och serienyckelpar](features/destinations/key-value-pairs.md)
   ...
   + Regler för profilsammanslagning{#profile-merge-rules}
      ...
      + [Rapportera mått för profilkopplingsregler](features/profile-merge-rules/profile-link-metrics.md)
   ...
   + Traits{#traits}
      ...
      + Trait Builder{#trait-builder}
         ...
         + [Skapa regelbaserade eller introduktionskunskaper](features/traits/create-onboarded-rule-based-traits.md)
      ...
      + [Geogeting med tangenter på Platform-nivå](features/traits/trait-geotarget-keys.md)
...
+ Rapporter {#reporting}
   ...
   + Målgruppsoptimeringsrapporter {#audience-optimization-reports}
      ...
      + Audience Optimization for Advertisers {#audience-optimization-advertisers}
         + [Målgruppsoptimering för annonsörer - översikt](reporting/audience-optimization-reports/aor-advertisers/aor-advertisers.md)
      ...
      + Målgruppsoptimering för utgivare {#audience-optimization-publishers}
         + [Målgruppsoptimering för utgivare - översikt](reporting/audience-optimization-reports/aor-publishers/aor-publishers.md)
      ...
      + Data- och metadatafiler för målgruppsoptimeringsrapporter och åtgärdsloggfiler {#data-and-metadata-files}
         + [ Loggdata och metadatafiler](reporting/audience-optimization-reports/metadata-files-intro/metadata-files-intro.md)
         + [Datafiler för målgruppsoptimeringsrapporter och körbara loggfiler](reporting/audience-optimization-reports/metadata-files-intro/datafiles-intro.md)
...
+ API och SDK-kod{#api-and-sdk-code}
   ...
   + REST API:er{#rest-apis}
      ...
      + [API-metoder för dataintegreringsbibliotek](api/rest-api-main/aam-api-dil-methods.md)
...
+ API för dataintegreringsbibliotek (DIL){#dil-api}
   ...
   + DIL-metoder på klassnivå{#class-level-dil-methods}
      ...
      + [DIL skapa](dil/dil-class-overview/dil-create.md)
   ...
   + [DIL-metoder på förekomstnivå](dil/dil-instance-methods.md)
...
+ Handböcker för implementering och integrering{#implementation-integration-guides}
   ...
   + Integrera DFP med Google Publisher Tags (GPT){#integrate-dfp-using-gpt}
      + [Integrera DFP med GPT-översikt](integration/gpt-aam-destination/gpt-aam-overview.md)
   ...
   + Integrera med tredjepartsmål {#integrating-third-party}
      ...
      + [DFP som mål för Audience Manager](integration/aam-dfp.md)
   ...
   + Integrering av mediedata{#media-data-integration}
      ...
      + [Åtgärdsbara loggfiler](integration/media-data-integration/actionable-log-files.md)
   ...
   + Tar emot målgruppsdata{#receiving-audience-data}
      ...
      + Batchutgående dataöverföringar{#batch-outbound-data-transfers}
         ...
         + [Utnyttja behörigheter för Amazon S3 Cross Account Bucket för dina utgående filer](integration/receiving-audience-data/batch-outbound-transfers/authorize-s3-cross-bucket.md)
   ...
   + Integration med Adobe Experience Platform {#integration-experience-platform}
   ...
   + Integrering med andra Experience Cloud-lösningar {#integration-other-solutions}
      ...
      + [Publicera ett Adobe Analytics-segment på Experience Cloud (öppnar Adobe Analytics-dokumentationen)](https://docs.adobe.com/content/help/en/core-services/interface/audiences/t-publish-audience-segment.html)
...
+ Referens{#reference}
   ...
   + Systemkomponenter{#system-components}
      ...
      + [Tagghanteringskomponenter](reference/system-components/components-tag-management.md)
      + [Platform Architecture: Dataflödesschema](reference/system-components/components-platform-architecture.md)
...
+ De vanligaste frågorna för kundsupport{#top-support-issues}
   ...
   + [Vi är ingen Audience Manager-kund, men se Audience Manager Javascript-samtalen på vår webbplats](/help/using/support-issues/not-using-aam-but-seeing-aam-javascript.md)
