...
title: Index för ID i Audience Manager
...
| [!DNL ImsOrgId] | [!DNL Organization ID]. Detta är det ID som ett företag får när det registrerar sig för ett [!DNL Experience Cloud]-konto. | `5DC5123F5245B1D20A490D46@AdobeOrg` | Visas inte i användargränssnittet för [!DNL Audience Manager]. Läs [!DNL Organization ID]Hitta ditt företags-ID[ om du vill veta hur du kan hitta ditt företags ](https://experienceleague.adobe.com/docs/core-services/interface/manage-users-and-products/organizations.html?lang=sv-SE#concept_EA8AEE5B02CF46ACBDAD6A8508646255). |
| [!DNL PID] | [!DNL Partner ID]. [!DNL PID] är företagets ID i [!DNL Audience Manager]. Audience Manager associerar en [!DNL imsOrgId] med en [!DNL PID]. | `1352` | Visas inte i användargränssnittet för [!DNL Audience Manager]. |
| [!DNL ECID], [!DNL MID] | ID för [!DNL Experience Cloud]. [!DNL Experience Cloud]-ID ([!DNL ECID], tidigare förkortningar [!DNL MID] eller [!DNL MCID]) hämtas matematiskt från din [!DNL Organization ID] och [!DNL Audience Manager] [!UICONTROL Unique User ID]. Så länge dessa ID:n är konstanta är det helt enkelt ett viktigt problem att generera rätt [!DNL ECID] för en viss användare. Med samma [!DNL Organization ID] och [!DNL Audience Manager] [!DNL UUID] får du samma [!DNL ECID]-värde varje gång. Du kan läsa mer om [!DNL ECID] i dokumentationen för [cookies och Experience Cloud ID](https://experienceleague.adobe.com/docs/id-service/using/intro/cookies.html?lang=sv-SE#section-15f69c0bac394b4b9966a23fbc586d17). | `mid = 08382830887934830189014177072406221371` | Visas inte i användargränssnittet för [!DNL Audience Manager]. |
