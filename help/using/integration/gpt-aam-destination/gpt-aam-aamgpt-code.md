---
description: AamGpt är en JavaScript-funktion som läser Audience Manager cookie-data och skickar den informationen till Google Publisher-taggar.
...
title: Audience Manager Code for Google Publisher-taggar
...
# Audience Manager Code for Google Publisher-taggar {#audience-manager-code-for-google-publisher-tags}
...
Placera `AamGpt`-koden högst upp på sidan, helst inuti `<head>`-kodblocket. Koden `AamGpt` finns nedan:
