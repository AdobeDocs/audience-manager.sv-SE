...
<table id="table_1EA97D75004148CE85F702427DB7E97A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Sökvägen till och namnet på din <span class="keyword"> Audience Manager</span> FTP-katalog. Kontakta kontohanteraren för att få information om FTP-katalogen och autentiseringsuppgifter. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> <i>DPID</i> </code> </p> </td> 
   <td colname="col2"> <p>Ett ID som talar om för <span class="keyword"> Audience Manager</span> om en datafil innehåller dina egna användar-ID:n, Android- eller iOS-ID:n. Följande alternativ godkänns: </p> 
    <ul id="ul_818EB3EB2E5543F0B048BCEBB6699562"> 
     ...
     <li id="li_1955911BA11F4F458227B77F383F25A3"> <b>Android ID (GAID):</b> Använd ID 20914 i ett datafilnamn om det innehåller Android-ID. Till exempel anger <code>...ftp_dpm_20914_123456789.sync</code> <span class="keyword"> Audience Manager</span> att datafilen endast innehåller Android-ID:n. </li> 
