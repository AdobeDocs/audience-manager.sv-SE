 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="../../../features/traits/manage-trait-rules.md#managing-trait-rules"> Med svällningsregler </a> kan du ange kriterier för kvalificering av egenskaper. Om du formaterar en trait-regel som <code> ic == trait ID </code>kan du skicka in traits i en enkel kommaformaterad lista. </p> <p>Exempel: du skapar följande 3-trait-regler: </p> <p> 
     ...
     </ul> </p> <p>Dessa egenskaper är kopplade till <code> ic </code> nyckeln. På så sätt kan du skapa en enklare lista över egenskaper i datafilen. Och du behöver inte ta med <code> ic </code> prefixet. Innehållet i datafilen kan därför se ut så här: </p> <p>
     <code> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Fackdata kan formateras som nyckelvärdepar med alfanumeriska strängar. Det finns flera sätt att formatera nyckelvärdepar, vilket visas nedan: </p> <p> 
     ...
     </ul><code> "age"="32" </code> , <code> "gender"=m </code> , <code> model = "pickup truck" </code> , <code> product = tablet </code> är alla exempel på korrekt formaterade nyckelvärdepar. </p> </td> 
  </tr>
 </tbody>
</table>
...
<table id="table_8C5C7271B813441EA2D45CA2FE2A6C59"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><i>Använd inte</i> ett kodat kolon ( <code> %3A </code>) eller ett okodat kolon (: ) i DPUID. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_41A4991090A64DEFA9AF704164B26DBB"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> TAB </code> </p> </td> 
   <td colname="col2"> <p><i>Använd inte</i> i stället <code> TAB </code> för tomma värden i nyckelvärdepar. Använd bara <code> TAB </code> för att separera variabler i den inkommande datafilen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> \n, \t </code> </p> </td> 
   <td colname="col2"> <p>Använd inte de nya rad- eller tabbtecknen ( <code> \n, \t </code>) i tangenter eller i värden. </p> </td> 
  </tr>
 </tbody>
</table>
...
<table id="table_8017E070F7A54143A82CA153CBAEB5DA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dessa egenskaper har lagts till i en trait-regel med <code> ic </code> prefixet . Därför kan du lägga till dem i datafilen avgränsade med kommatecken. En flik skiljer UUID och trait ID:n. Prefixet <code> ic </code> krävs inte i filen. </p> <p><b>Numeriska ID:n</b> </p> <p> 
     <code>
...
[Hämta](assets/ftp_dpm_1234_1445374061.overwrite) exempeldatafilen om du behöver fler exempel. Den hämtade filen har ett `.overwrite` filtillägg. Du kan öppna den med en enkel textredigerare.
...
<table id="table_FE6D97A1F5074E4A8EFC723AF0C5E707"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <a href="../../../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md#example-15"> Exempel 14 </a> </p> </td> 
